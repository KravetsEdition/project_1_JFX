...
public class Mp3 implements AutoCloseable {
    ...
    public Mp3(File f) { // Класс не мой, тому я хз как здесь всё работает. Но оно работает и это главное!)
        try {
	...
	*/
    ...
    public static Mp3 playSound(String path) {
